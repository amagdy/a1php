...
<table width="100%" border="0" cellspacing="0" cellpadding="4" dir="rtl">
	...
	<tr bgcolor="{cycle values="#EEEEEE,#DDDDDD"}">			
		...
		<td><div align="center">{$arr_groups[groupid].layout}</div></td>		<td><div align="center"><a class="mylink" href="{make_link controller="group" action="getone" id=$arr_groups[groupid].id}">عرض</a></div></td>
